...
```
执行结果：
![rag-reader-text.png](imgs/rag-reader-text.png)
...
```
报错：
![rag-reader-pdf-error.png](imgs/rag-reader-pdf-error.png)
...
![rag-reader-pdf.png](imgs/rag-reader-pdf.png)
#### 1.2.4 HTML读取器
...
```
执行结果：
![rag-reader-html.png](imgs/rag-reader-html.png)
#### 1.2.5 Markdown读取器
引入依赖：
```xml
<dependency>
...
```
执行结果：
![rag-reader-markdown.png](imgs/rag-reader-markdown.png)
#### 1.2.6 JSON读取器
引入依赖：
```xml
<dependency>
...
```
执行结果：
![rag-reader-json.png](imgs/rag-reader-json.png)
#### 1.2.7 通用Tika读取器
...
```
执行结果：
![rag-reader-tika-doc.png](imgs/rag-reader-tika-doc.png)
![rag-reader-tika-ppt.png](imgs/rag-reader-tika-ppt.png)
### 1.3 文档清洗
...
执行结果：
![unstructured-partition-pdf.png](imgs/unstructured-partition-pdf.png)
